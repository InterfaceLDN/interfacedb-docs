...
![Documentation screenshot](/img/docs/devtool-pointer.jpg)
...
![Documentation screenshot](/img/docs/devtool-explorer.png)

Or the `Sandbox` to try out different queries and transactions:

![Documentation screenshot](/img/docs/devtool-sandbox.png)
