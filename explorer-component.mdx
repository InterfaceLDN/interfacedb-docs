...
```tsx
import './App.css';
import { Explorer, Toaster } from '@interface-db/components';
...
module.exports = {
  content: [
    ...
    './utils/**/*.{js,ts,jsx,tsx}',
    './node_modules/@interface-db/components/src/**/*.{js,ts,jsx,tsx,md}',
  ],
};
```
...
```css
@import 'tailwindcss';
@source '../node_modules/@interface-db/components';
```
