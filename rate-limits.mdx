...
You can add rate limiting to your app with the `rateLimit` object in the [permission rules](/permissions). Rate limits let you control how often users can perform actions like creating records or querying data.
