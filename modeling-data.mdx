...
With Instant you can define your schema and your permissions in code. If you haven't already, use the [CLI](/cli) to generate an `instant.schema.ts` and an `instant.perms.ts` file:
...
Found @interface-db/react in your package.json.
...
When you do this, all [queries](/instaql) and [transactions](/instaml) will come with typesafety out of the box.
...
![Documentation screenshot](/img/docs/modeling-data-rename-attr.png)
