...
Add indexes and checked types to your attributes from the [Explorer on the Instant dashboard](https://interfacedb.com/dash?t=explorer) or from the [cli](/cli).
...
Add indexes and checked types to your attributes from the [Explorer on the Instant dashboard](https://interfacedb.com/dash?t=explorer) or from the [cli with Schema-as-code](/modeling-data).
...
don't want to expose, you'll want to use [permissions](/permissions#fields) to restrict access.
...
As your app grows, you may want to start enforcing types. When you're ready you can write a [schema](/modeling-data). If your schema includes `goals` and `todos` for example:
...
![Documentation screenshot](/img/docs/instaql-todos-goals-autocomplete.png)

And if you hover over `data`, you'll see the actual typed output of your query:

![Documentation screenshot](/img/docs/instaql-data-intellisense.png)
...
```typescript
import { InstaQLParams } from '@interface-db/react';
...
```typescript
import { InstaQLResult } from '@interface-db/react';
import { AppSchema } from '../instant.schema.ts';
...
```typescript
import { InstaQLEntity } from '@interface-db/react';
import { AppSchema } from '../instant.schema.ts';
...
To learn more about writing schemas, check out the [Modeling Data](/modeling-data) section.
