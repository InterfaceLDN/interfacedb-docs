...
```javascript
import { init, i, id, InstaQLEntity } from "@interface-db/core";
...
Huzzah 🎉 You've got your first Instant web app running! Check out the [Working with data](/init) section to learn more about how to use Instant :)
